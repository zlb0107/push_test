...
```yaml
- package: git.inke.cn/BackendPlatform/jaeger-client-go
  version: ^2.7.0
```
...
```shell
go get -u git.inke.cn/BackendPlatform/jaeger-client-go/
cd $GOPATH/src/git.inke.cn/BackendPlatform/jaeger-client-go/
...
See tracer initialization examples in [godoc](https://godoc.org/git.inke.cn/BackendPlatform/jaeger-client-go/config#pkg-examples)
...
[doc-img]: https://godoc.org/git.inke.cn/BackendPlatform/jaeger-client-go?status.svg
[doc]: https://godoc.org/git.inke.cn/BackendPlatform/jaeger-client-go
