...
func (r *loggingReporter) Report(span *Span) {
	r.logger.Infof("Reporting span %+v %+v %+v", span, span.tags, span.references)
}
...
type remoteReporter struct {
	...
	// Cf. https://git.inke.cn/BackendPlatform/jaeger-client-go/issues/155, https://goo.gl/zW7dgq
	queueLength int64
