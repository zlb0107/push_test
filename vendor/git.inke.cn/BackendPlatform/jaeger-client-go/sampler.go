...
import (
	...
	"git.inke.cn/BackendPlatform/jaeger-client-go/thrift-gen/sampling"
...
const maxRandomNumber uint64 = 0xfffff // i.e. 0xfffff
...
func (s *ProbabilisticSampler) IsSampled(id TraceID, operation string) (bool, []Tag) {
	return s.samplingBoundary >= id.Low&(0xfffff), s.tags
}
