...
import (
	...
	"git.inke.cn/BackendPlatform/jaeger-client-go/thrift-gen/agent"
	"git.inke.cn/BackendPlatform/jaeger-client-go/thrift-gen/jaeger"
	"git.inke.cn/BackendPlatform/jaeger-client-go/thrift-gen/zipkincore"
)
